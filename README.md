## Лабораторная работа №1: Веб-страница для проверки попадания точки в область на плоскости

## Автор
**ФИО:** Лишик Александра Юрьевна  
**Группа:** Р3206  
**Вариант:** 12606  
**Дата выполнения:** 15 сентября 2026
...
Разработанная HTML-страница должна удовлетворять следующим требованиям (требования различаются между вариантами!):
    ...
    При работе с CSS должно быть продемонстрировано использование селекторов псевдоэлементов, селекторов классов, селекторов потомств, селекторов дочерних элементов, а также такие свойства стилей CSS, как наследование и каскадирование.
...
![Область для попадания точки](img.png)
